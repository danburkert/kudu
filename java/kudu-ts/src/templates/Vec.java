...
import com.google.common.primitives.{ShortType}s;
...
/**
 * A vector of primitive {Primitive}s.
 *
...
final class {ShortType}Vec {
  ...
  private {ShortType}Vec(int capacity) {
    data = new {Primitive}[capacity];
    len = 0;
  }
   ...
   */
  public static {ShortType}Vec create() {
    return new {ShortType}Vec(DEFAULT_CAPACITY);
  }
   ...
   */
  public static {ShortType}Vec withCapacity(int capacity) {
   ...
   */
  public void push({Primitive} element) {
    reserve(1);
    data[len++] = element;
  }
   ...
   */
  public void set(int index, {Primitive} value) {
   ...
   */
  public void concat({ShortType}Vec other) {
   ...
   */
  public void merge({ShortType}Vec other) {
   ...
   */
  public void intersect({ShortType}Vec other) {
    int writeOffset = 0;
    int otherOffset = 0;
  ...
  public List<{Type}> asList() {
    List<{Type}> list = {ShortType}s.asList(data);
  ...
  public boolean equals(Object o) {
    ...
    {ShortType}Vec other = ({ShortType}Vec) o;
  ...
  /** {@inheritDoc} */
  @Override
  protected {ShortType}Vec clone() {
    {ShortType}Vec clone = new {ShortType}Vec(0);
    clone.data = Arrays.copyOf(data, data.length);
    clone.len = len;
    return clone;
  }

  /** An iterator of primitive {Primitive}s. */
  public class Iterator {
     ...
     */
    public void seekToValue({Primitive} value) {
