...
final class DoubleVec {
  ...
  private DoubleVec(int capacity) {
   ...
   */
  public static DoubleVec create() {
    return new DoubleVec(DEFAULT_CAPACITY);
  }
   ...
   */
  public static DoubleVec withCapacity(int capacity) {
    return new DoubleVec(capacity);
  }
  ...
  /**
   * Shorten the vector to be {@code len} elements double.
   ...
   */
  public void concat(DoubleVec other) {
   ...
   */
  public void merge(DoubleVec other) {
   ...
   */
  public void intersect(DoubleVec other) {
    int writeOffset = 0;
    int otherOffset = 0;
  ...
  /** {@inheritDoc} */
  @Override
  protected DoubleVec clone() {
    DoubleVec clone = new DoubleVec(0);
    clone.data = Arrays.copyOf(data, data.length);
    clone.len = len;
    return clone;
  }

  /** An iterator of primitive doubles. */
  public class Iterator {
     ...
     */
    public void seekToValue(double value) {
