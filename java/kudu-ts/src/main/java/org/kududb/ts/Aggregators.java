...
public class Aggregators {
  ...
  private static class Min implements Aggregator {
    ...
    public String toString() {
      return Objects.toStringHelper(this).add("min", min).toString();
    }
  }
  ...
  private static class Max implements Aggregator {
    ...
    @Override
    public String toString() {
      return Objects.toStringHelper(this).add("max", max).toString();
    }
  }
  ...
  private static class Sum implements Aggregator {
    ...
    @Override
    public String toString() {
      return Objects.toStringHelper(this).add("sum", sum).toString();
    }
  }
  ...
  private static class StandardDeviation implements Aggregator {
    ...
    @Override
    public double aggregatedValue() {
      double stddev = Math.sqrt(samples > 1 ? newS/(samples - 1) : 0.0);
      samples = 0;
      return stddev;
    }
    @Override
