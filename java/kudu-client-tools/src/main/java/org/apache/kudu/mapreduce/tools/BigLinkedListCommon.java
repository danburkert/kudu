...
public class BigLinkedListCommon {
  ...
  public static final String GENERATOR_NUM_ROWS_PER_MAP_KEY
      = "IntegrationTestBigLinkedList.generator.num_rows";

  public static final String GENERATOR_NUM_MAPPERS_KEY
      = "IntegrationTestBigLinkedList.generator.map.tasks";

  public static final String GENERATOR_WIDTH_KEY
      = "IntegrationTestBigLinkedList.generator.width";

  public static final String GENERATOR_WRAP_KEY
      = "IntegrationTestBigLinkedList.generator.wrap";

  public static final int WIDTH_DEFAULT = 1000000;
  public static final int WRAP_DEFAULT = 25;
  public static final int ROWKEY_LENGTH = 16;
  ...
  public static <T> void circularLeftShift(T[] first) {
    T ez = first[0];
