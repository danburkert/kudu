...
public class TestKuduTable extends BaseKuduTest {
  ...
  public void testGetLocations() throws Exception {
    ...
    assertEquals(new Integer(defaultInt), kuduTable.getSchema().getColumnByIndex(0).getDefaultValue());
    ...
    assertEquals(1, client.getTablesList(tableWithDefault).join(DEFAULT_SLEEP).getTablesList().size());
