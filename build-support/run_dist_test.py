...
def main():
  ...
  env['HIVE_HOME'] = glob.glob(os.path.join(ROOT, "thirdparty/installed/common/opt/hive"))[0]
  env['HADOOP_HOME'] = glob.glob(os.path.join(ROOT, "thirdparty/installed/common/opt/hadoop"))[0]
