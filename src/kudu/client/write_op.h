...
class KUDU_EXPORT KuduInsert : public KuduWriteOperation {
 ...
 private:
  ...
  explicit KuduInsert(const std::shared_ptr<KuduTable>& table);
};
...
class KUDU_EXPORT KuduUpdate : public KuduWriteOperation {
 ...
 private:
  friend class KuduTable;
  explicit KuduUpdate(const std::shared_ptr<KuduTable>& table);
};
...
class KUDU_EXPORT KuduDelete : public KuduWriteOperation {
 ...
 private:
  friend class KuduTable;
  explicit KuduDelete(const std::shared_ptr<KuduTable>& table);
};
