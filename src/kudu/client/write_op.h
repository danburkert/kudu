...
class KUDU_EXPORT KuduWriteOperation {
 ...
 protected:
  explicit KuduWriteOperation(const kudu::shared_ptr<KuduTable>& table);
  virtual Type type() const = 0;

  kudu::shared_ptr<KuduTable> const table_;
  KuduPartialRow row_;
...
class KUDU_EXPORT KuduInsert : public KuduWriteOperation {
 ...
 private:
  ...
  explicit KuduInsert(const kudu::shared_ptr<KuduTable>& table);
};
...
class KUDU_EXPORT KuduUpdate : public KuduWriteOperation {
 ...
 private:
  friend class KuduTable;
  explicit KuduUpdate(const kudu::shared_ptr<KuduTable>& table);
};
...
class KUDU_EXPORT KuduDelete : public KuduWriteOperation {
 ...
 private:
  friend class KuduTable;
  explicit KuduDelete(const kudu::shared_ptr<KuduTable>& table);
};
