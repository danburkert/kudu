...
class KUDU_EXPORT KuduClientBuilder {
 public:
  ...
  // returned.
  Status Build(std::shared_ptr<KuduClient>* client);
 private:
...
class KUDU_EXPORT KuduClient : public std::enable_shared_from_this<KuduClient> {
 public:
  ~KuduClient();
  ...
  std::shared_ptr<KuduSession> NewSession();
...
//
// This class is thread-safe.
class KUDU_EXPORT KuduTable : public std::enable_shared_from_this<KuduTable> {
 public:
  ~KuduTable();
 ...
 private:
  ...
  KuduTable(const std::shared_ptr<KuduClient>& client,
...
class KUDU_EXPORT KuduSession : public std::enable_shared_from_this<KuduSession> {
 public:
  ~KuduSession();
 ...
 private:
  ...
  friend class KuduClient;
  friend class internal::Batcher;
  explicit KuduSession(const std::shared_ptr<KuduClient>& client);
