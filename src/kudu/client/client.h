...
class KUDU_EXPORT KuduClientBuilder {
 public:
  ...
  // returned.
  Status Build(kudu::shared_ptr<KuduClient>* client);
 private:
...
class KUDU_EXPORT KuduClient : public kudu::enable_shared_from_this<KuduClient> {
 public:
  ~KuduClient();
  ...
  kudu::shared_ptr<KuduSession> NewSession();
...
//
// This class is thread-safe.
class KUDU_EXPORT KuduTable : public kudu::enable_shared_from_this<KuduTable> {
 public:
  ~KuduTable();
 ...
 private:
  ...
  KuduTable(const kudu::shared_ptr<KuduClient>& client,
...
class KUDU_EXPORT KuduSession : public kudu::enable_shared_from_this<KuduSession> {
 public:
  ~KuduSession();
 ...
 private:
  ...
  friend class KuduClient;
  friend class internal::Batcher;
  explicit KuduSession(const kudu::shared_ptr<KuduClient>& client);
