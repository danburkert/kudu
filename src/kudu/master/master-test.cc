...
TEST_F(MasterTest, TestCreateTableCheckRangeInvariants) {
  ...
  { // Overlapping bounds.
    KuduPartialRow a_lower = KuduPartialRow(&kTableSchema);
    KuduPartialRow a_upper = KuduPartialRow(&kTableSchema);
    KuduPartialRow b_lower = KuduPartialRow(&kTableSchema);
    KuduPartialRow b_upper = KuduPartialRow(&kTableSchema);
  ...
  { // Split row out of bounds (above).
    KuduPartialRow bound_lower = KuduPartialRow(&kTableSchema);
    KuduPartialRow bound_upper = KuduPartialRow(&kTableSchema);
