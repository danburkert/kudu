...
class TlsContext {
 ...
 public:
  ...
  // used to transition to usuing the CA-signed cert with subsequent TLS
  // connections.
 ...
 private:
  ...
  // Protexts has_cert_ and csr_, as well as ctx_ and trusted_cert_count_ when
  // they need to be updated transactionally with has_cert_ and csr_.
  mutable Mutex lock_;
  bool has_cert_;
